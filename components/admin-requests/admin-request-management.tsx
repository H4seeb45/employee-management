      ...
      <Card className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="space-y-1">
            <Label className="text-xs uppercase text-muted-foreground font-semibold">Month</Label>
          ...
          <div className="space-y-1">
            <Label className="text-xs uppercase text-muted-foreground font-semibold">Year</Label>
          ...
          {isAdmin && (
            <div className="space-y-1">
              <Label className="text-xs uppercase text-muted-foreground font-semibold">Office / Location</Label>
                ...
                <TabsContent key={tab} value={tab} className="mt-0">
                  <div className="overflow-x-auto">
                    <Table>
                      <TableHeader>
                        <TableRow>
                          <TableHead className="hidden lg:table-cell">EMP ID</TableHead>
