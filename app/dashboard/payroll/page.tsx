    ...
    <div className="space-y-6 max-w-[1200px] mx-auto px-4 sm:px-6">
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 font-medium">
            Manage monthly salaries, incentives, and deductions for{" "}
      ...
      <Tabs defaultValue="payroll" className="w-full">
        <TabsList className="bg-slate-100/50 dark:bg-slate-800/50 p-1 rounded-xl mb-6">
          <TabsTrigger
            value="payroll"
            className="rounded-lg px-8 py-1.5 data-[state=active]:bg-slate-900 data-[state=active]:text-white"
          >
            Payroll
          </TabsTrigger>
          <TabsTrigger
